...
Public Class FrmCompletarOV
    ...
    Private Sub btCotizacion_Click(sender As Object, e As EventArgs) Handles btCotizacion.Click
        Try
            ...
            '    CuerpoMensaje = "<html xmlns:v='urn:schemas-microsoft-com:vml'
            ...
            '                    </style>
            '                    </head><body lang=ES-MX link='#0563C1' vlink='#954F72' style='tab-interval:35.4pt'>
            ...
            '</span><span style='font-family:' Bahnschrift Light',sans-serif'><a
            '                                                                     href='mailto:logistica@metas.mx'>logistica<span style='font-size:12.0pt'>@metas.mx</span></a></span><span
            '                                                                                                                                                                                     style='font-size:12.0pt;font-family:' Bahnschrift Light',sans-serif'><br>
            ...
            'privacidad en la p�gina web </span><span lang=ES style='mso-ansi-language:ES;
            'mso-fareast-language:ES'><a href='http://www.metas.com.mx/aviso-privacidad.html'><span
            '                                                                                     lang=ES-MX style='font-size:8.0pt;color:blue;mso-ansi-language:ES-MX;
