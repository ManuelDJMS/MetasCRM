...
Public Class FrmCotizadorLIMS
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        R = "Select [Cotizaciones].NumCot,FechaDesde,FechaHasta, [Prospectos]. Nombre + ' ' + Apellidos AS nom,Puesto, Telefono, Ext, Correo,
				...
				INNER JOIN [DATABASESERVER\COMPAC].[MetAs_Live-Clouding].[dbo].[SetUpEquipment] ON [SetUpEquipment].[EquipId] = [DetalleCotizaciones].[EquipId]
				INNER JOIN [DATABASESERVER\COMPAC].[MetAs_Live-Clouding].[dbo].[SetupEquipmentServiceMapping] ON [SetUpEquipment].[EquipId] =[SetupEquipmentServiceMapping].[EquipId]			
    ...
    Private Sub DgCot_RowHeaderMouseClick(sender As Object, e As DataGridViewCellMouseEventArgs) Handles dgCot.RowHeaderMouseClick
        Dim COT As Integer
        COT = Val(DGEmpresas.Rows(e.RowIndex).Cells(0).Value)
        MetodoMetasCotizador()
        comandoMetasCotizador = conexionMetasCotizador.CreateCommand
        ' Dim n As Integer = 0
        Dim desde, hasta As Date
